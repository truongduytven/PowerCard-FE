          ...
          return (
            <div className="md:px-18" key={flashcard.id}>
              <AnimatedBorderCard className="my-4 w-full">
                <div className="flex flex-col md:flex-row w-full md:px-6 py-4 md:items-center gap-4">
                  ...
                  {/* Image */}
                  <div className="relative w-[100px] order-5 md:order-4 shrink-0 px-6 md:px-0">
                    {imageUrl ? (
                      <>
                        <img
                          src={imageUrl}
                      ...
                      <>
                        {editingId === flashcard.id && (
                          <label className="cursor-pointer">
                            <div className='order-5 md:order-4 w-[100px] border-2 border-dashed h-20 flex justify-center items-center rounded-lg'>
