...
import { BookOpen, Filter, Star, Zap, Globe } from "lucide-react";
...
/* ===== COMPONENT ===== */
export function ExploreCommunity({ exploreDecks }: ExploreCommunityProps) {
  return (
    <div>
      {/* Header */}
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="px-3 py-1.5 text-xs font-medium text-violet-600 dark:text-violet-400 border border-violet-200 dark:border-violet-800 hover:text-white hover:bg-gradient-to-r hover:from-violet-600 hover:to-purple-600 hover:border-transparent rounded-lg transition-all"
                >
                  Preview
                </Button>
              </div>
